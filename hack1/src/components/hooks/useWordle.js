...
const useWordle = (solution) => {
    ...
    const handleEnter = () => {
        ...
        let copied_guesses = guesses
        let info = [{char:curGuess[0], color:'grey'},{char:curGuess[1], color:'grey'},{char:curGuess[2], color:'grey'},{char:curGuess[3], color:'grey'},{char:curGuess[4], color:'grey'}]
        ...
        for(let j=0 ; j<curGuess.length ; j++){
            if (info[j].color !== 'green'){
                for (let k=0 ; k<curGuess.length ; k++){
                    if (curGuess[j] === solution[k]){
                        if (used[k] === 0){
                            info[j].color = 'yellow'
                            used[k] = 1
                            break
